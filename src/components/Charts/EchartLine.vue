...
import { BASIC_LINE_OPTIONS, EMPTY_LINE_OPTIONS } from './default_options'
export default {
  name: 'EchartLine',
  props: {
    containerId: {
  ...
  methods: {
    ...
    mergeOptions() {
      ...
      return merge(
        ...
        BASIC_LINE_OPTIONS,
        {
          ...
          xAxis: [{
            data: _this.optionsData.XData
          }],
          series: [{
            data: _this.optionsData.dataList1
          }, {
            data: _this.optionsData.dataList2
          }, {
            data: _this.optionsData.dataList3
          }]
        }
      )
    },
    ...
    updateChartView() {
      if (!this.$_basicChart) return
      const mergeOptions = isEmpty(this.optionsData.XData) ? EMPTY_LINE_OPTIONS : this.mergeOptions()
